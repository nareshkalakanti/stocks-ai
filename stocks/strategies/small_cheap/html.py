"""HTML report for Small + Cheap strategy scan."""
...
SMALL_CHEAP_JS_COLS = [
    ...
    {"id": "sc_score", "label": "Score", "fmt": "num1"},
    ...
    {"id": "debt_free", "label": "Low debt", "fmt": "text"},
...
def build_small_cheap_html(
    df: pd.DataFrame,
    *,
    title: str = "Small + Cheap",
    ...
    section = build_interactive_section(
        "smallcheap",
        "Small + Cheap — 20–200 Cr · Mcap/Sales < 1 · low debt",
        work,
        SMALL_CHEAP_JS_COLS,
        kind="small_cheap",
        open_section=True,
...
def small_cheap_iframe_height(row_count: int) -> int:
