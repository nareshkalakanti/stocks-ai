...
ORDER_INFLOW_CACHE_HOURS = int(os.getenv("ORDER_INFLOW_CACHE_HOURS", "168"))
ORDER_INFLOW_LOOKBACK_DAYS = int(os.getenv("ORDER_INFLOW_LOOKBACK_DAYS", "730"))
ORDER_INFLOW_MAX_WORKERS = int(os.getenv("ORDER_INFLOW_MAX_WORKERS", "8"))
ORDER_INFLOW_MIN_VALUE_CR = float(os.getenv("ORDER_INFLOW_MIN_VALUE_CR", "0.5"))
