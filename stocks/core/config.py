...
FORMULA_100X_CFO_EBIT_MIN = float(os.getenv("FORMULA_100X_CFO_EBIT_MIN", "60"))
FORMULA_100X_EBT_CAPITAL_MIN = float(os.getenv("FORMULA_100X_EBT_CAPITAL_MIN", "12"))
FORMULA_100X_CFO_MCAP_MIN = float(os.getenv("FORMULA_100X_CFO_MCAP_MIN", "15"))
FORMULA_100X_LOOKBACK_YEARS = int(os.getenv("FORMULA_100X_LOOKBACK_YEARS", "5"))
...
MERGER_DEMERGER_LOOKBACK_YEARS = int(os.getenv("MERGER_DEMERGER_LOOKBACK_YEARS", "4"))
