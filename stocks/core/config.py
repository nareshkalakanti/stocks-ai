...
# Label used in UI error messages for the India listings universe.
INDIA_STOCKS_DATASET = "NSE equity listings (EQUITY_L + SME)"
...
GOVERNANCE_MAP_MCAP_FILL_BATCH = int(
    os.getenv("GOVERNANCE_MAP_MCAP_FILL_BATCH", "80")
)
